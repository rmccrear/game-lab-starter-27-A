...
function setupAnimations(){
  ...
  cloudAnimation = loadAnimation("sprites/cloud.png");
  friendAnimation = loadAnimation("sprites/purple.png");
  fenceAnimation = loadAnimation("sprites/fence.png");
  alienAnimation = loadAnimation("sprites/fly.png");
  appleAnimation = loadAnimation("sprites/apple.png");
  broccoliAnimation = loadAnimation("sprites/broccoli.png");
  pizzaAnimation = loadAnimation("sprites/pizza.png");
  cakeAnimation = loadAnimation("sprites/cake.png");
  platformAnimation1 = loadAnimation("sprites/plate.png");
  platformAnimation2 = loadAnimation("sprites/couch.png");
  sunAnimation = loadAnimation("sprites/sun.png");
}